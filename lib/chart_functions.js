...
showYears = function(id, chartInfo)
{
  ...
  /*
  $('.years-activate').on('mouseover', function()
  {
      $($(this).parent()).children('.highcharts-container').fadeIn('500');
      $(this).css("background-color", "#FFFFAA");
  });
  $('.years-activate').on('mouseout', function()
  {
      $($(this).parent()).children('.highcharts-container').fadeOut('300');
...
// sample call to 'displayChart'
//    displayChart('internetyears', 'Internet in Life', 'Without Internet', chartData(yearstotal, 'Without Internet', 'With Internet', '#55BF3B', '#DDDF0D', 1991));  
